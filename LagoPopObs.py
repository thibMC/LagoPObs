...
class LagoPopObsUI(tk.Tk):
    def __init__(self):
        ...
        button_dir_input = ttk.Button(self, text="Select input folder", command=self.input_folder)
        ...
        button_dir_output = ttk.Button(self, text="Select ouput folder", command=self.output_folder)
        ...
        # Separator
        ttk.Separator(self, orient="horizontal").grid(row=7, column=0, columnspan=2, sticky="ew", pady = 20)
        ...
        button_proceed = ttk.Button(self, text="Validate and proceed to analysis", command=self.validate_proceed)
    ...
    def input_folder(self):
        ...
        if folder != ():
            ...
            if wav_check:
                ...
                showwarning(title="Wrong input folder!", message="No WAV files in your input folder!")
